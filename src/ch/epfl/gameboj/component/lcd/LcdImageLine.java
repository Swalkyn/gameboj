...
public final class LcdImageLine {
    ...
    /**
     * Mutable builder for LcdImageLine
     */
    public static final class Builder {
         ...
         * @throws IllegalArgumentException if the given size is negative or not a multiple of 32
         */
        ...
        public LcdImageLine build() {
            ...
            // Create new builder so builder can be reused
            msbBuilder = new BitVector.Builder(size);
            lsbBuilder = new BitVector.Builder(size);
     ...
     * @throws NullPointerException if line or opacity vector is null
     * @throws IllegalArgumentException if lines are not the same size
     * @return a new line with the pixels of the combined lines
     */
    ...
    public boolean equals(Object that) {
        if (that instanceof LcdImageLine && ((LcdImageLine) that).size == size) {
            ...
            return this.msb.equals(lcdImgLine.msb)
                && this.lsb.equals(lcdImgLine.lsb)
                && this.opacity.equals(lcdImgLine.opacity);
        }
        return false;
    }
    ...
    private int extractColor(int palette, int index) {
        return Bits.clip(2, palette >>> index * 2);
    }
